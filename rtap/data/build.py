...
from rtap.cfg import IterableSimpleNamespace
from rtap.data.dataset import (
    DepthDataset,
    GroundingDataset,
...
from rtap.data.utils import IMG_FORMATS, VID_FORMATS
from rtap.utils import RANK, colorstr
from rtap.utils.checks import check_file
from rtap.utils.torch_utils import TORCH_1_13, TORCH_2_0, TORCH_2_7, get_torch_device_backend
...
def check_source(
    ...
    if isinstance(source, (str, int, Path)):  # int for local usb camera
        ...
        raise TypeError("Unsupported image type. For supported types see /modes/predict")
