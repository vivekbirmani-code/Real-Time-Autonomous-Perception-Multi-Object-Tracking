...
from rtap.utils import LOCAL_RANK, LOGGER, NUM_THREADS, TQDM, colorstr
from rtap.utils.instance import Instances
from rtap.utils.ops import resample_segments, segments2boxes
from rtap.utils.torch_utils import TORCHVISION_0_18
...
# RTAP dataset *.cache version, >= 1.0.0 for RTAP models
...
class ClassificationDataset:
    ...
    def cache_images(self) -> None:
        ...
        (); one shared numpy buffer is read-only across
