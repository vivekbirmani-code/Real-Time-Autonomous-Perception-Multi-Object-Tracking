...
from rtap.cfg import get_cfg, get_save_dir
from rtap.data import load_inference_source
from rtap.data.augment import LetterBox
from rtap.nn.autobackend import AutoBackend
from rtap.utils import DEFAULT_CFG, LOGGER, MACOS, WINDOWS, callbacks, colorstr, ops
from rtap.utils.checks import check_imgsz, check_imshow
from rtap.utils.plotting import class_activation_map
from rtap.utils.torch_utils import attempt_compile, select_device, smart_inference_mode

STREAM_WARNING = """
Inference results will accumulate in RAM unless `stream=True` is passed, which can cause out-of-memory errors for large
sources or long-running streams and videos. See /modes/predict/ for help.
...
class BasePredictor:
    ...
    def __call__(self, source=None, model=None, stream: bool = False, *args, **kwargs):
        ...
        Returns:
            (list[rtap.engine.results.Results] | generator): Results objects or generator of Results objects.
        """
        self.stream = stream
        if stream:
    ...
    def stream_inference(self, source=None, model=None, *args, **kwargs):
        ...
        Yields:
            (rtap.engine.results.Results): Results objects.
        """
