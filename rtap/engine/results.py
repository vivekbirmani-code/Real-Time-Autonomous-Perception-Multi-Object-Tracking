...
"""
RTAP Results, Boxes, Masks, SemanticMask, Keypoints, Probs, and OBB classes for handling inference results.

Usage: See /modes/predict/
"""
...
from rtap.utils import LOGGER, DataExportMixin, SimpleClass, ops
from rtap.utils.plotting import Annotator, colors, save_one_box
...
class BaseTensor(SimpleClass):
    ...
    def cuda(self):
        ...
        Examples:
            >>> import torch
            >>> from rtap.engine.results import BaseTensor
            >>> data = torch.tensor([[1, 2, 3], [4, 5, 6]])
            >>> base_tensor = BaseTensor(data, orig_shape=(720, 1280))
            >>> gpu_tensor = base_tensor.cuda()
...
class Results(SimpleClass, DataExportMixin):
    ...
    This class provides comprehensive functionality for handling inference results from various RTAP models,
...
class Keypoints(BaseTensor):
    ...
    Examples:
        >>> import torch
        >>> from rtap.engine.results import Keypoints
