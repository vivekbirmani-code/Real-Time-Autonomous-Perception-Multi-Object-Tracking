...
from rtap.cfg import _YOLO_CLI_COMMAND, get_cfg, get_save_dir
from rtap.data.utils import check_cls_dataset, check_det_dataset, convert_ndjson_to_yolo_if_needed
from rtap.nn.distill_model import DistillationModel
from rtap.nn.tasks import load_checkpoint
from rtap.optim import MuSGD
...
from rtap.utils.checks import check_amp, check_file, check_imgsz, check_model_file_from_stem, print_args
from rtap.utils.dist import ddp_cleanup, generate_ddp_command
from rtap.utils.files import get_latest_run
        ...
        for k, v in self.model.named_parameters():
            ...
            if any(x in k for x in freeze_layer_names):
                ...
                LOGGER.warning(
                    ...
                    "See rtap.engine.trainer for customization of frozen layers."
                )
    ...
    def build_optimizer(self, model, name="auto", lr=0.001, momentum=0.9, decay=1e-5, iterations=1e5):
        ...
        if name in {"Adam", "Adamax", "AdamW", "NAdam", "RAdam"}:
            ...
            raise NotImplementedError(
                ...
                "Request support for additional optimizers at "
            )
...
class MultiTrainer:
    ...
    def train(self):
        ...
        from rtap.utils.patches import torch_load, torch_save
    ...
    def plot_results(self):
        ...
        from rtap.cfg import TASK2METRIC
