...
"""
Module provides functionalities for hyperparameter tuning of the RTAP models for object detection, instance
...
from rtap.cfg import _YOLO_CLI_COMMAND, CFG_INT_KEYS, get_cfg, get_save_dir
from rtap.utils import DEFAULT_CFG, LOGGER, YAML, callbacks, colorstr, remove_colorstr
from rtap.utils.checks import check_requirements
from rtap.utils.patches import torch_load
from rtap.utils.plotting import plot_tune_results
...
class Tuner:
    ...
    def __init__(self, args=DEFAULT_CFG, _callbacks: dict | None = None):
        ...
        mongodb_db = args.pop("mongodb_db", "rtap")
        ...
        LOGGER.info(
            ...
            f"{self.prefix}💡 Learn about tuning at /guides/hyperparameter-tuning"
        )
