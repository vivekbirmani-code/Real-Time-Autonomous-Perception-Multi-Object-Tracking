...
class NAS(Model):
    ...
    This class provides an interface for the YOLO-NAS models and extends the `Model` class from RTAP engine. It
    ...
    Examples:
        >>> from rtap import NAS
        >>> model = NAS("yolo_nas_s")
        >>> results = model.predict("rtap/assets/bus.jpg")
