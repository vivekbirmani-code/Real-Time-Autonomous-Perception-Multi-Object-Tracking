...
class NASPredictor(DetectionPredictor):
    """RTAP NAS Predictor for object detection.

    This class extends the DetectionPredictor from RTAP engine and is responsible for post-processing the raw
    ...
    def postprocess(self, preds_in, img, orig_imgs):
        ...
        post-processing operations to generate the final detection results compatible with RTAP result
