...
This module provides an interface to the Segment Anything Model (SAM) from RTAP, designed for real-time image
...
from rtap.utils.torch_utils import model_info
...
class SAM(Model):
    ...
    This class provides an interface to the Segment Anything Model (SAM) from RTAP, designed for promptable
    ...
    def task_map(self) -> dict[str, dict[str, type[Predictor]]]:
        ...
        Examples:
            ...
            >>> print(task_map)
            {'segment': {'predictor': <class 'rtap.models.sam.predict.Predictor'>}}
        """
        return {
