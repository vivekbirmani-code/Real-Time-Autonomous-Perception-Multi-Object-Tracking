...
using SAM. It forms an integral part of the RTAP framework and is designed for high-performance, real-time image
segmentation tasks.
"""
...
from rtap.data.augment import LetterBox
from rtap.engine.predictor import BasePredictor
from rtap.engine.results import Results
from rtap.utils import DEFAULT_CFG, LOGGER, ops
from rtap.utils.metrics import box_iou, mask_iou
from rtap.utils.torch_utils import select_device, smart_inference_mode
...
class Predictor(BasePredictor):
    ...
    def generate(
        ...
        """
        import torchvision  # scope for faster 'import rtap'
    ...
    def setup_model(self, model=None, verbose=True):
        ...
        parameters for image normalization and other RTAP compatibility settings.
        ...
        # RTAP compatibility settings
        self.model.format = "sam"
        self.model.base_model = False  # SAMModel is no RTAP BaseModel and honors neither `augment` nor `embed`
...
class SAM3SemanticPredictor(SAM3Predictor):
    ...
    def _get_dummy_prompt(self, num_prompts=1):
        ...
        # Scoped for import rtap speed: SAM3 geometry imports optional torchvision ops.
        from .sam3.geometry_encoders import Prompt
...
class SAM3VideoSemanticPredictor(SAM3SemanticPredictor):
    ...
    def _associate_det_trk(
        ...
        if self.o2o_matching_masklets_enable:
            from rtap.utils.ops import linear_sum_assignment
