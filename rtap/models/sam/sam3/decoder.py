...
from rtap.nn.modules.transformer import MLP
from rtap.nn.modules.utils import _get_clones, inverse_sigmoid
...
class TransformerDecoder(nn.Module):
    ...
    def __init__(
        ...
        if interaction_layer is not None:
            # Scoped for import rtap speed: ROI align requires optional torchvision ops.
