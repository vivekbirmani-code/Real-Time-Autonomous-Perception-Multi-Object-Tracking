...
from rtap.data.augment import classify_transforms
from rtap.engine.predictor import BasePredictor
from rtap.engine.results import Results
from rtap.utils import DEFAULT_CFG, ops
...
class ClassificationPredictor(BasePredictor):
    ...
    Examples:
        >>> from rtap.utils import ASSETS
        >>> from rtap.models.yolo.classify import ClassificationPredictor
