...
from rtap.data import ClassificationDataset, build_dataloader
from rtap.engine.trainer import BaseTrainer
from rtap.models import yolo
from rtap.nn.tasks import ClassificationModel
from rtap.utils import DEFAULT_CFG, LOGGER, RANK
from rtap.utils.plotting import plot_images
from rtap.utils.torch_utils import is_parallel, torch_distributed_zero_first
...
class ClassificationTrainer(BaseTrainer):
    ...
    Examples:
        ...
        >>> from rtap.models.yolo.classify import ClassificationTrainer
    ...
    def get_dataloader(self, dataset_path: str, batch_size: int = 16, rank: int = 0, mode: str = "train"):
        ...
        if not dataset.samples:
            raise FileNotFoundError(
                ...
                f"See /datasets/classify for cls dataset format."
            )
