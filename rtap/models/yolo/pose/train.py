...
from rtap.nn.tasks import PoseModel
from rtap.utils import DEFAULT_CFG, RANK
...
class PoseTrainer(yolo.detect.DetectionTrainer):
    ...
    Examples:
        >>> from rtap.models.yolo.pose import PoseTrainer
    ...
    def get_dataset(self) -> dict[str, Any]:
        ...
        if "kpt_shape" not in data:
            raise KeyError(f"No `kpt_shape` in the {self.args.data}. See /datasets/pose/")
        return data
