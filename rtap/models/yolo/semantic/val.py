...
from rtap.data.dataset import SemanticDataset
from rtap.data.utils import add_polygon_background
from rtap.models.yolo.detect import DetectionValidator
from rtap.utils import LOGGER, RANK
from rtap.utils.metrics import ConfusionMatrix, SemanticMetrics
...
class SemanticSegmentationValidator(DetectionValidator):
    ...
    Examples:
        >>> from rtap.models.yolo.semantic import SemanticSegmentationValidator
