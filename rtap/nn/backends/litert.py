...
from rtap.utils import LOGGER, NUM_THREADS
...
class LiteRTBackend(BaseBackend):
    ...
    Loads and runs inference with LiteRT models (.tflite files) exported via ai-edge-litert/litert-torch. RTAP
    ...
    def forward(self, im: torch.Tensor) -> list[np.ndarray]:
        ...
        # RTAP exports keep float I/O, but quantize here too for full-integer .tflite (legacy onnx2tf or
