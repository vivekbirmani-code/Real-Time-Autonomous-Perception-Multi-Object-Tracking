...
class QNNBackend(BaseBackend):
    ...
    Loads and runs the QNN context binary produced by the RTAP QNN export (`*_qnn.onnx`) using ONNX Runtime with
    ...
    def load_model(self, weight: str | Path) -> None:
        ...
        from rtap.utils.export.qnn import qnn_library_paths
