...
from rtap.utils.torch_utils import fuse_conv_and_bn
...
class Proto(nn.Module):
    """RTAP models mask Proto module for segmentation models."""

    def __init__(self, c1: int, c_: int = 256, c2: int = 32):
        """Initialize the RTAP models mask Proto module with specified number of protos and masks.
...
class C2fPSA(C2f):
    ...
    Examples:
        >>> import torch
        >>> from rtap.nn.modules.block import C2fPSA
...
class SCDown(nn.Module):
    ...
    Examples:
        >>> import torch
        >>> from rtap.nn.modules.block import SCDown
...
class Proto26(Proto):
    """RTAP26 models mask Proto module for segmentation models."""
