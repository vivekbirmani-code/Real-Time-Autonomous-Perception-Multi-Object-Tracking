...
from rtap.utils import WEIGHTS_DIR, checks
from rtap.utils.torch_utils import smart_inference_mode

try:
    import clip
except ImportError:
    checks.check_requirements("git+https://github.com/rtap/CLIP.git")
    import clip
...
class MobileCLIP(TextModel):
    ...
    def __init__(self, size: str, device: torch.device) -> None:
        ...
        try:
            ...
            # RTAP fork preferred since Apple MobileCLIP repo has incorrect version of torchvision
            checks.check_requirements("git+https://github.com/rtap/mobileclip.git")
            import mobileclip
