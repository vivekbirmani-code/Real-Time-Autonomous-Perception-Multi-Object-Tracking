...
from rtap.solutions.solutions import BaseSolution, SolutionResults  # Import a parent class
from rtap.utils import plt_settings
...
class Analytics(BaseSolution):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.title = "RTAP Solutions"  # window name
