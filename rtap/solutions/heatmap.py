...
from rtap.solutions.object_counter import ObjectCounter
from rtap.solutions.solutions import SolutionAnnotator, SolutionResults
...
class Heatmap(ObjectCounter):
    ...
    Examples:
        >>> from rtap.solutions import Heatmap
    ...
    def process(self, im0: np.ndarray) -> SolutionResults:
        """Generate heatmap for each frame using RTAP tracking.
