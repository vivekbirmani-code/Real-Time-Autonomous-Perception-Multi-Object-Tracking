...
from rtap.solutions.solutions import BaseSolution, SolutionResults
...
class InstanceSegmentation(BaseSolution):
    ...
    def process(self, im0) -> SolutionResults:
        ...
        if self.masks is None:
            self.LOGGER.warning("No masks detected! Ensure you're using a supported RTAP segmentation model.")
            plot_im = im0
        else:
