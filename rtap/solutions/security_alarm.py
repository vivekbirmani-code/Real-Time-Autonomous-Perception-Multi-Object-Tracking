...
from rtap.solutions.solutions import BaseSolution, SolutionAnnotator, SolutionResults
...
class SecurityAlarm(BaseSolution):
    ...
    def send_email(self, im0, records: int = 5) -> None:
        ...
        message_body = f"RTAP alert: {records} object(s) detected."
        message.attach(MIMEText(message_body))

        # Attach the image
        image_attachment = MIMEImage(img_bytes, name="rtap.jpg")
