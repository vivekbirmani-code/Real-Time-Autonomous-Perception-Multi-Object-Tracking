...
from rtap.utils import LOGGER
from rtap.utils.checks import check_requirements
from rtap.utils.downloads import GITHUB_ASSETS_STEMS
...
class Inference:
    ...
    real-time inference using Streamlit and RTAP models.
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        """
        check_requirements("streamlit>=1.29.0")  # scope imports for faster rtap package load speeds
        ...
        LOGGER.info(f"RTAP Solutions: ✅ {self.temp_dict}")
    ...
    def web_ui(self) -> None:
        ...
        font-family: 'Archivo', sans-serif; margin-bottom:20px;">RTAP Streamlit Application</h1></div>"""
        ...
        with the power of RTAP! 🚀</h5></div>"""

        # Set html page configuration and append custom HTML
        self.st.set_page_config(page_title="RTAP Streamlit App", layout="wide")
    ...
    def sidebar(self) -> None:
        ...
        with self.st.sidebar:  # Add RTAP LOGO
            logo = "https://raw.githubusercontent.com/rtap/assets/main/logo/RTAP_Logotype_Original.svg"
    ...
    def source_upload(self) -> None:
        ...
        from rtap.data.utils import IMG_FORMATS, VID_FORMATS  # scope import
        ...
        if self.source == "video":
            ...
            if vid_file is not None:
                ...
                with open("rtap.mp4", "wb") as out:  # Open temporary file as bytes
                    out.write(g.read())  # Read bytes into file
                self.vid_file_name = "rtap.mp4"
