...
class FastSTrack(STrack):
    ...
    Examples:
        >>> from rtap.trackers.utils.kalman_filter import KalmanFilterXYAH
...
class FASTTracker(BYTETracker):
    ...
    Examples:
        ...
        >>> from rtap.trackers import FASTTracker
        >>> from rtap.utils import YAML, IterableSimpleNamespace
        >>> cfg = IterableSimpleNamespace(**YAML.load("rtap/cfg/trackers/fasttrack.yaml"))
