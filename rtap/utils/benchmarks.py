...
Usage:
    from rtap.utils.benchmarks import ProfileModels, benchmark
...
from rtap import RTDETR, YOLO, YOLOWorld
from rtap.cfg import TASK2DATA, TASK2METRIC
from rtap.engine.exporter import export_formats
from rtap.nn.modules import Segment26
...
from rtap.utils.checks import IS_PYTHON_MINIMUM_3_13, check_imgsz, check_requirements, check_rtap, is_rockchip
from rtap.utils.files import file_size
from rtap.utils.torch_utils import get_cpu_info, select_device
...
def benchmark(
    ...
    **kwargs,
    ...
    # Print results
    check_rtap(device=device)  # print system info
