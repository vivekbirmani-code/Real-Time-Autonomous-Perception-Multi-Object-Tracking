...
"""Base callbacks for RTAP training, validation, prediction, and export processes."""
...
def get_default_callbacks():
    """Get the default callbacks for RTAP training, validation, prediction, and export processes.
...
def add_integration_callbacks(instance):
    ...
    """
    from rtap.utils.events import callbacks as events_cb
