...
"""
MLflow Logging for RTAP.

This module enables MLflow logging for RTAP. It logs metrics, parameters, and model artifacts.
...
from rtap.utils import LOGGER, RUNS_DIR, SETTINGS, TESTS_RUNNING, colorstr, env_bool
...
def on_pretrain_routine_end(trainer):
    ...
    Args:
        trainer (rtap.engine.trainer.BaseTrainer): The training object with arguments and parameters to log.
    ...
    experiment_name = os.environ.get("MLFLOW_EXPERIMENT_NAME") or trainer.args.project or "/Shared/RTAP"
