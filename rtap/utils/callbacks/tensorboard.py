...
from rtap.utils import LOGGER, SETTINGS, TESTS_RUNNING, colorstr, torch_utils
...
def _log_tensorboard_graph(trainer) -> None:
    ...
    Args:
        trainer (rtap.engine.trainer.BaseTrainer): The trainer object containing the model to visualize. Must
