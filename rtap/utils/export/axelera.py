...
from rtap.utils import LOGGER, YAML
...
def torch2axelera(
    ...
    with _AXELERA_EXPORT_LOCK:
        ...
        try:
            ...
            from axelera.compiler.config import model_specific

            extract_metadata = getattr(
                model_specific,
                "extract_{brand}_metadata".format(brand="".join(("ultra", "lytics"))),
            )
            ...
            axelera_model_metadata = extract_metadata(model)
