...
from rtap.utils import IS_JETSON, LOGGER, TORCH_VERSION, ThreadingLocked, is_dgx, is_jetson
from rtap.utils.checks import check_requirements, check_tensorrt, check_version
from rtap.utils.torch_utils import TORCH_2_4, TORCH_2_9
...
def modelopt_quantize_onnx(
    ...
    Args:
        ...
        dataset (rtap.data.build.InfiniteDataLoader | None): Dataloader providing INT8 calibration images.
    ...
    if quantize == 8:
        ...
        modelopt_quantize(
            ...
            # mirroring the OpenVINO IgnoredScope 
...
def onnx2engine(
    ...
    Args:
        ...
        dataset (rtap.data.build.InfiniteDataLoader, optional): Dataset for INT8 calibration.
    ...
    check_version(trt.__version__, "!=10.2.0", msg="")
    ...
    if use_int8 and not is_trt11:
        ...
        class EngineCalibrator(trt.IInt8Calibrator):
            ...
            def __init__(
                self,
                dataset,  # rtap.data.build.InfiniteDataLoader
                cache: str = "",
            ) -> None:
