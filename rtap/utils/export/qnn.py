...
from rtap.utils import LOGGER, QNN_HTP_TARGETS, WINDOWS
...
def onnx2qnn(
    ...
    Args:
        ...
        metadata (dict | None): RTAP model metadata ensured present in the context model's `metadata_props` (ONNX
    ...
    from rtap.utils.export.onnx import onnx_calibration_reader
    ...
    if metadata:  # ensure RTAP metadata is present in the context model (usually preserved by ONNX Runtime)
        import onnx
