...
from rtap.utils import LOGGER, DataExportMixin, SimpleClass, TryExcept, checks, plt_settings
...
def smooth_bce(eps: float = 0.1) -> tuple[float, float]:
    ...
    References:
        https://github.com/rtap/yolov3/issues/238#issuecomment-598028441
    """
...
class Metric(SimpleClass):
    """Class for computing evaluation metrics for RTAP models.
