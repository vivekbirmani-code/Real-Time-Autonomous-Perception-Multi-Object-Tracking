...
from rtap.cfg import TASK2DATA, TASK2METRIC, get_cfg, get_save_dir
from rtap.utils import DEFAULT_CFG, DEFAULT_CFG_DICT, LOGGER, NUM_THREADS, checks, colorstr
...
def run_ray_tune(
    ...
    **train_args,
    ...
    """
    LOGGER.info("💡 Learn about RayTune at /integrations/ray-tune")
    try:
